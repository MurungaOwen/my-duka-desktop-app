...
type UpdateCategoryInput = store.UpdateCategoryInput
type Category = store.Category
type CreateProductInput = store.CreateProductInput
type UpdateProductInput = store.UpdateProductInput
...
type ListRecentMPesaPaymentsInput = store.ListRecentMPesaPaymentsInput
type RecentMPesaPayment = store.RecentMPesaPayment
